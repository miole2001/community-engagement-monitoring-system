<?php 
   ...
   $db_name = 'mysql:host=localhost;dbname=cems_accounts';
   $db_user_name = 'root';
   $db_user_pass = '';
   ...
   $db_name = 'mysql:host=localhost;dbname=cems_logs';
   $db_user_name = 'root';
   $db_user_pass = '';
   ...
   $db_name = 'mysql:host=localhost;dbname=cems_engagementActivites';
   $db_user_name = 'root';
   $db_user_pass = '';

   $connForActivities = new PDO($db_name, $db_user_name, $db_user_pass);
?>